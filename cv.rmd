...
CV <- create_CV_object(
  data_location = "https://docs.google.com/spreadsheets/d/18zACMXUxmmmBl3ZQpG1HxSBzab_9UkJKRcHwAtG7P0/",  
...
The source code is available [on github.com/vasantm/cv](https://github.com/vasantm/cv).
